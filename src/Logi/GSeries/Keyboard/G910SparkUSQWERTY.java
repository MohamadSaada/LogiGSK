 ...
 */
public class G910SparkUSQWERTY extends javax.swing.JInternalFrame {
    ...
    private final int keyCount = 116;
     ...
     */
    public G910SparkUSQWERTY() {
        initComponents();

        //remove hash from US QWERTY layout, please note that this layout has
        //been adapted from UK QWERTY and for ease of adaptation I done this
        // the correct way would be to implement the US QWERTY layout from scratch
        jPanelColour071.setVisible(false);
        
        //Remove title bar from this JInternalFrame (Cosmetic)
        ((javax.swing.plaf.basic.BasicInternalFrameUI) this.getUI()).setNorthPane(null);

        //instantiate a GKeyboard object
        gKeyboard = new GKeyboard(Keyboard.KeyboardModel.Logi910SparkUSQWERTY);

        //load current profile from file
        gKeyboard = IOOperations.loadCurrentKeyboardObjectFromFile(Keyboard.KeyboardModel.Logi910SparkUSQWERTY);
        ...
        if (gKeyboard.getEffect() != null) {
            ...
            //load colour profile
            loadColours(convertStandardKeyColourMapToG910ColourMap(gKeyboard.getKeyColourMap()));
                ...
                if (selectedButton != null) {
                    switch (selectedButton) {
                        ...
                        case "061":
                            ...
                            break;
                        case "062":
                            jPanelColour062.setBackground(jColorChooserFreeStyle.getColor());
                        ...
                        case "089":
                            ...
                            gKeyboard.setKey("num_1", hexColour, true);
                            break;
                        case "090":
                            jPanelColour090.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour090);
                            gKeyboard.setKey("num_2", hexColour, true);
                            break;
                        case "091":
                            jPanelColour091.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour091);
                            gKeyboard.setKey("num_3", hexColour, true);
                            break;
                        case "092":
                            jPanelColour092.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour092);
                            gKeyboard.setKey("num_enter", hexColour, true);
                            break;
                        case "093":
                            jPanelColour093.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour093);
                            gKeyboard.setKey("ctrl_left", hexColour, true);
                            break;
                        case "094":
                            jPanelColour094.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour094);
                            gKeyboard.setKey("win_left", hexColour, true);
                            break;
                        case "095":
                            jPanelColour095.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour095);
                            gKeyboard.setKey("alt_left", hexColour, true);
                            break;
                        case "096":
                            jPanelColour096.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour096);
                            gKeyboard.setKey("space", hexColour, true);
                            break;
                        case "097":
                            jPanelColour097.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour097);
                            gKeyboard.setKey("alt_right", hexColour, true);
                            break;
                        case "098":
                            jPanelColour098.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour098);
                            gKeyboard.setKey("win_right", hexColour, true);
                            break;
                        case "099":
                            jPanelColour099.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour099);
                            gKeyboard.setKey("menu", hexColour, true);
                            break;
                        case "100":
                            jPanelColour100.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour100);
                            gKeyboard.setKey("ctrl_right", hexColour, true);
                            break;
                        case "101":
                            jPanelColour101.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour101);
                            gKeyboard.setKey("arrow_left", hexColour, true);
                            break;
                        case "102":
                            jPanelColour102.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour102);
                            gKeyboard.setKey("arrow_bottom", hexColour, true);
                            break;
                        case "103":
                            jPanelColour103.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour103);
                            gKeyboard.setKey("arrow_right", hexColour, true);
                            break;
                        case "104":
                            jPanelColour104.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour104);
                            gKeyboard.setKey("num_0", hexColour, true);
                            break;
                        case "105":
                            jPanelColour105.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour105);
                            gKeyboard.setKey("num_dot", hexColour, true);
                            break;
                        case "106":
                            jPanelColour106.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour106);
                            gKeyboard.setKey("g1", hexColour, true);
                            break;
                        case "107":
                            jPanelColour107.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour107);
                            gKeyboard.setKey("g2", hexColour, true);
                            break;
                        case "108":
                            jPanelColour108.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour108);
                            gKeyboard.setKey("g3", hexColour, true);
                            break;
                        case "109":
                            jPanelColour109.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour109);
                            gKeyboard.setKey("g4", hexColour, true);
                            break;
                        case "110":
                            jPanelColour110.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour110);
                            gKeyboard.setKey("g5", hexColour, true);
                            break;
                        case "111":
                            jPanelColour111.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour111);
                            gKeyboard.setKey("g6", hexColour, true);
                            break;
                        case "112":
                            jPanelColour112.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour112);
                            gKeyboard.setKey("g7", hexColour, true);
                            break;
                        case "113":
                            jPanelColour113.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour113);
                            gKeyboard.setKey("g8", hexColour, true);
                            break;
                        case "114":
                            jPanelColour114.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour114);
                            gKeyboard.setKey("g9", hexColour, true);
                            break;
                        case "115":
                            jPanelColour115.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour115);
                            gKeyboard.setKey("logo", hexColour, true);
                            break;
                        case "116":
                            jPanelColour116.setBackground(jColorChooserFreeStyle.getColor());
                            jLayeredPane1.moveToBack(jPanelColour116);
                            gKeyboard.setKey("badge", hexColour, true);
                            break;
                        case "117":
                            //jPanelColour117.setBackground(jColorChooserLEDCustom.getColor());
                            //jLayeredPane1.moveToBack(jPanelColour117);
                            //gKeyboard.setKey("", hexColour , true);
                            break;
                        case "118":
                            //jPanelColour118.setBackground(jColorChooserLEDCustom.getColor());
                            //jLayeredPane1.moveToBack(jPanelColour118);
                            //gKeyboard.setKey("", hexColour , true);
                            break;
                        case "119":
                            //jPanelColour119.setBackground(jColorChooserLEDCustom.getColor());
                            //jLayeredPane1.moveToBack(jPanelColour119);
                            //gKeyboard.setKey("", hexColour , true);
                            break;
                        case "120":
                            //jPanelColour120.setBackground(jColorChooserLEDCustom.getColor());
                            //jLayeredPane1.moveToBack(jPanelColour120);
                            //gKeyboard.setKey("", hexColour , true);
                            break;
                        case "121":
                            //jPanelColour121.setBackground(jColorChooserLEDCustom.getColor());
                            //jLayeredPane1.moveToBack(jPanelColour121);
                            //gKeyboard.setKey("", hexColour , true);
                            break;
                        case "122":
                            //jPanelColour122.setBackground(jColorChooserLEDCustom.getColor());
                            //jLayeredPane1.moveToBack(jPanelColour122);
                            //gKeyboard.setKey("", hexColour , true);
                            break;
                        case "123":
                            //jPanelColour123.setBackground(jColorChooserLEDCustom.getColor());
                            //jLayeredPane1.moveToBack(jPanelColour123);
                            //gKeyboard.setKey("", hexColour , true);
                            break;
                        case "124":
                            //jPanelColour124.setBackground(jColorChooserLEDCustom.getColor());
                            //jLayeredPane1.moveToBack(jPanelColour124);
                            //gKeyboard.setKey("", hexColour , true);
                            break;
                        case "125":
                            //jPanelColour125.setBackground(jColorChooserLEDCustom.getColor());
                            //jLayeredPane1.moveToBack(jPanelColour125);
                            //gKeyboard.setKey("", hexColour , true);
                            break;
                        case "126":
                            //jPanelColour126.setBackground(jColorChooserLEDCustom.getColor());
                            //jLayeredPane1.moveToBack(jPanelColour126);
                            //gKeyboard.setKey("", hexColour , true);
                            break;
                    }
                }
        ...
        jColorChooserZones.getSelectionModel().addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                ...
                switch (jListZones.getSelectedValue()) {
                    case "Logos":
                        selectedGroup = "logo";
                        jPanelColour115.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour115);
                        jPanelColour116.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour116);
                        break;
                    case "G Keys":
                        selectedGroup = "gKeys";
                        jPanelColour106.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour106);
                        jPanelColour107.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour107);
                        jPanelColour108.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour108);
                        jPanelColour109.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour109);
                        jPanelColour110.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour110);
                        jPanelColour111.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour111);
                        jPanelColour112.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour112);
                        jPanelColour113.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour113);
                        jPanelColour114.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour114);
                        break;
                    case "F Keys":
                        selectedGroup = "fkeys";
                    ...
                    case "Modifiers":
                        ...
                        jLayeredPane1.moveToBack(jPanelColour075);
                        jPanelColour093.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour093);
                        jPanelColour094.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour094);
                        jPanelColour095.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour095);
                        jPanelColour096.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour096);
                        jPanelColour097.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour097);
                        jPanelColour098.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour098);
                        jPanelColour099.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour099);
                        jPanelColour100.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour100);
                    ...
                    case "Arrows":
                        ...
                        jLayeredPane1.moveToBack(jPanelColour088);
                        jPanelColour101.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour101);
                        jPanelColour102.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour102);
                        jPanelColour103.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour103);
                        break;
                    case "WASD":
                        selectedGroup = "wasd";
                    ...
                    case "Numeric":
                        ...
                        jLayeredPane1.moveToBack(jPanelColour089);
                        jPanelColour090.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour090);
                        jPanelColour091.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour091);
                        jPanelColour092.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour092);
                        jPanelColour104.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour104);
                        jPanelColour105.setBackground(jColorChooserZones.getColor());
                        jLayeredPane1.moveToBack(jPanelColour105);
                        break;
                    case "Functions":
    ...
    private void initComponents() {
        ...
        jPanelColour116 = new javax.swing.JPanel();
        jPanelColour115 = new javax.swing.JPanel();
        jPanelColour114 = new javax.swing.JPanel();
        jPanelColour113 = new javax.swing.JPanel();
        jPanelColour112 = new javax.swing.JPanel();
        jPanelColour111 = new javax.swing.JPanel();
        jPanelColour110 = new javax.swing.JPanel();
        jPanelColour109 = new javax.swing.JPanel();
        jPanelColour108 = new javax.swing.JPanel();
        jPanelColour107 = new javax.swing.JPanel();
        jPanelColour106 = new javax.swing.JPanel();
        jPanelColour105 = new javax.swing.JPanel();
        jPanelColour104 = new javax.swing.JPanel();
        jPanelColour103 = new javax.swing.JPanel();
        jPanelColour102 = new javax.swing.JPanel();
        jPanelColour101 = new javax.swing.JPanel();
        jPanelColour100 = new javax.swing.JPanel();
        jPanelColour099 = new javax.swing.JPanel();
        jPanelColour098 = new javax.swing.JPanel();
        jPanelColour097 = new javax.swing.JPanel();
        jPanelColour096 = new javax.swing.JPanel();
        jPanelColour095 = new javax.swing.JPanel();
        jPanelColour094 = new javax.swing.JPanel();
        jPanelColour093 = new javax.swing.JPanel();
        jPanelColour092 = new javax.swing.JPanel();
        jPanelColour091 = new javax.swing.JPanel();
        jPanelColour090 = new javax.swing.JPanel();
        ...
        jPanelGKeys = new javax.swing.JPanel();
        ...
        jListZones.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Logos", "G Keys", "F Keys", "Modifiers", "Arrows", "WASD", "Numeric", "Functions", "Keys" };
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Logi/GSeries/Keyboard/Resources/Images/G910_Orion_Spark_US_QWERTY.png"))); // NOI18N
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jPanel5.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, 1014, -1));

        jPanelColour116.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour116.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour116MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour116Layout = new javax.swing.GroupLayout(jPanelColour116);
        jPanelColour116.setLayout(jPanelColour116Layout);
        jPanelColour116Layout.setHorizontalGroup(
            jPanelColour116Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 50, Short.MAX_VALUE)
        );
        jPanelColour116Layout.setVerticalGroup(
            jPanelColour116Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour116, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 294, 50, 20));

        jPanelColour115.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour115.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour115MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour115Layout = new javax.swing.GroupLayout(jPanelColour115);
        jPanelColour115.setLayout(jPanelColour115Layout);
        jPanelColour115Layout.setHorizontalGroup(
            jPanelColour115Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );
        jPanelColour115Layout.setVerticalGroup(
            jPanelColour115Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour115, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 56, 30, 30));

        jPanelColour114.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour114.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour114MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour114Layout = new javax.swing.GroupLayout(jPanelColour114);
        jPanelColour114.setLayout(jPanelColour114Layout);
        jPanelColour114Layout.setHorizontalGroup(
            jPanelColour114Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour114Layout.setVerticalGroup(
            jPanelColour114Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour114, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 20, 20, 30));

        jPanelColour113.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour113.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour113MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour113Layout = new javax.swing.GroupLayout(jPanelColour113);
        jPanelColour113.setLayout(jPanelColour113Layout);
        jPanelColour113Layout.setHorizontalGroup(
            jPanelColour113Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour113Layout.setVerticalGroup(
            jPanelColour113Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour113, new org.netbeans.lib.awtextra.AbsoluteConstraints(285, 20, 20, 30));

        jPanelColour112.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour112.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour112MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour112Layout = new javax.swing.GroupLayout(jPanelColour112);
        jPanelColour112.setLayout(jPanelColour112Layout);
        jPanelColour112Layout.setHorizontalGroup(
            jPanelColour112Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour112Layout.setVerticalGroup(
            jPanelColour112Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour112, new org.netbeans.lib.awtextra.AbsoluteConstraints(251, 20, 20, 30));

        jPanelColour111.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour111.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour111MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour111Layout = new javax.swing.GroupLayout(jPanelColour111);
        jPanelColour111.setLayout(jPanelColour111Layout);
        jPanelColour111Layout.setHorizontalGroup(
            jPanelColour111Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour111Layout.setVerticalGroup(
            jPanelColour111Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour111, new org.netbeans.lib.awtextra.AbsoluteConstraints(218, 20, 20, 30));

        jPanelColour110.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour110.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour110MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour110Layout = new javax.swing.GroupLayout(jPanelColour110);
        jPanelColour110.setLayout(jPanelColour110Layout);
        jPanelColour110Layout.setHorizontalGroup(
            jPanelColour110Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour110Layout.setVerticalGroup(
            jPanelColour110Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour110, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 230, 20, 30));

        jPanelColour109.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour109.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour109MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour109Layout = new javax.swing.GroupLayout(jPanelColour109);
        jPanelColour109.setLayout(jPanelColour109Layout);
        jPanelColour109Layout.setHorizontalGroup(
            jPanelColour109Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour109Layout.setVerticalGroup(
            jPanelColour109Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour109, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 195, 20, 30));

        jPanelColour108.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour108.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour108MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour108Layout = new javax.swing.GroupLayout(jPanelColour108);
        jPanelColour108.setLayout(jPanelColour108Layout);
        jPanelColour108Layout.setHorizontalGroup(
            jPanelColour108Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour108Layout.setVerticalGroup(
            jPanelColour108Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour108, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 162, 20, 30));

        jPanelColour107.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour107.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour107MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour107Layout = new javax.swing.GroupLayout(jPanelColour107);
        jPanelColour107.setLayout(jPanelColour107Layout);
        jPanelColour107Layout.setHorizontalGroup(
            jPanelColour107Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour107Layout.setVerticalGroup(
            jPanelColour107Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour107, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 129, 20, 30));

        jPanelColour106.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour106.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour106MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour106Layout = new javax.swing.GroupLayout(jPanelColour106);
        jPanelColour106.setLayout(jPanelColour106Layout);
        jPanelColour106Layout.setHorizontalGroup(
            jPanelColour106Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour106Layout.setVerticalGroup(
            jPanelColour106Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour106, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 96, 20, 30));

        jPanelColour105.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour105.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour105MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour105Layout = new javax.swing.GroupLayout(jPanelColour105);
        jPanelColour105.setLayout(jPanelColour105Layout);
        jPanelColour105Layout.setHorizontalGroup(
            jPanelColour105Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour105Layout.setVerticalGroup(
            jPanelColour105Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour105, new org.netbeans.lib.awtextra.AbsoluteConstraints(854, 235, 20, 20));

        jPanelColour104.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour104.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour104MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour104Layout = new javax.swing.GroupLayout(jPanelColour104);
        jPanelColour104.setLayout(jPanelColour104Layout);
        jPanelColour104Layout.setHorizontalGroup(
            jPanelColour104Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );
        jPanelColour104Layout.setVerticalGroup(
            jPanelColour104Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour104, new org.netbeans.lib.awtextra.AbsoluteConstraints(798, 235, 30, 20));

        jPanelColour103.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour103.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour103MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour103Layout = new javax.swing.GroupLayout(jPanelColour103);
        jPanelColour103.setLayout(jPanelColour103Layout);
        jPanelColour103Layout.setHorizontalGroup(
            jPanelColour103Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour103Layout.setVerticalGroup(
            jPanelColour103Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour103, new org.netbeans.lib.awtextra.AbsoluteConstraints(743, 230, 20, 30));

        jPanelColour102.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour102.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour102MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour102Layout = new javax.swing.GroupLayout(jPanelColour102);
        jPanelColour102.setLayout(jPanelColour102Layout);
        jPanelColour102Layout.setHorizontalGroup(
            jPanelColour102Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour102Layout.setVerticalGroup(
            jPanelColour102Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour102, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 230, 20, 30));

        jPanelColour101.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour101.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour101MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour101Layout = new javax.swing.GroupLayout(jPanelColour101);
        jPanelColour101.setLayout(jPanelColour101Layout);
        jPanelColour101Layout.setHorizontalGroup(
            jPanelColour101Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour101Layout.setVerticalGroup(
            jPanelColour101Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour101, new org.netbeans.lib.awtextra.AbsoluteConstraints(676, 229, 20, 30));

        jPanelColour100.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour100.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour100MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour100Layout = new javax.swing.GroupLayout(jPanelColour100);
        jPanelColour100.setLayout(jPanelColour100Layout);
        jPanelColour100Layout.setHorizontalGroup(
            jPanelColour100Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );
        jPanelColour100Layout.setVerticalGroup(
            jPanelColour100Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour100, new org.netbeans.lib.awtextra.AbsoluteConstraints(618, 235, 30, 20));

        jPanelColour099.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour099.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour099MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour099Layout = new javax.swing.GroupLayout(jPanelColour099);
        jPanelColour099.setLayout(jPanelColour099Layout);
        jPanelColour099Layout.setHorizontalGroup(
            jPanelColour099Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour099Layout.setVerticalGroup(
            jPanelColour099Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour099, new org.netbeans.lib.awtextra.AbsoluteConstraints(575, 235, 20, 20));

        jPanelColour098.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour098.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour098MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour098Layout = new javax.swing.GroupLayout(jPanelColour098);
        jPanelColour098.setLayout(jPanelColour098Layout);
        jPanelColour098Layout.setHorizontalGroup(
            jPanelColour098Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour098Layout.setVerticalGroup(
            jPanelColour098Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour098, new org.netbeans.lib.awtextra.AbsoluteConstraints(535, 235, 20, 20));

        jPanelColour097.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour097.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour097MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour097Layout = new javax.swing.GroupLayout(jPanelColour097);
        jPanelColour097.setLayout(jPanelColour097Layout);
        jPanelColour097Layout.setHorizontalGroup(
            jPanelColour097Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 40, Short.MAX_VALUE)
        );
        jPanelColour097Layout.setVerticalGroup(
            jPanelColour097Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour097, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 235, 40, 20));

        jPanelColour096.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour096.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour096MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour096Layout = new javax.swing.GroupLayout(jPanelColour096);
        jPanelColour096.setLayout(jPanelColour096Layout);
        jPanelColour096Layout.setHorizontalGroup(
            jPanelColour096Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 140, Short.MAX_VALUE)
        );
        jPanelColour096Layout.setVerticalGroup(
            jPanelColour096Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour096, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 235, 140, 20));

        jPanelColour095.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour095.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour095MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour095Layout = new javax.swing.GroupLayout(jPanelColour095);
        jPanelColour095.setLayout(jPanelColour095Layout);
        jPanelColour095Layout.setHorizontalGroup(
            jPanelColour095Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour095Layout.setVerticalGroup(
            jPanelColour095Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour095, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 235, 20, 20));

        jPanelColour094.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour094.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour094MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour094Layout = new javax.swing.GroupLayout(jPanelColour094);
        jPanelColour094.setLayout(jPanelColour094Layout);
        jPanelColour094Layout.setHorizontalGroup(
            jPanelColour094Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour094Layout.setVerticalGroup(
            jPanelColour094Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour094, new org.netbeans.lib.awtextra.AbsoluteConstraints(218, 235, 20, 20));

        jPanelColour093.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour093.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour093MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour093Layout = new javax.swing.GroupLayout(jPanelColour093);
        jPanelColour093.setLayout(jPanelColour093Layout);
        jPanelColour093Layout.setHorizontalGroup(
            jPanelColour093Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 40, Short.MAX_VALUE)
        );
        jPanelColour093Layout.setVerticalGroup(
            jPanelColour093Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 30, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour093, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 40, 30));

        jPanelColour092.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour092.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour092MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour092Layout = new javax.swing.GroupLayout(jPanelColour092);
        jPanelColour092.setLayout(jPanelColour092Layout);
        jPanelColour092Layout.setHorizontalGroup(
            jPanelColour092Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour092Layout.setVerticalGroup(
            jPanelColour092Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 50, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour092, new org.netbeans.lib.awtextra.AbsoluteConstraints(889, 202, 20, 50));

        jPanelColour091.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour091.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour091MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour091Layout = new javax.swing.GroupLayout(jPanelColour091);
        jPanelColour091.setLayout(jPanelColour091Layout);
        jPanelColour091Layout.setHorizontalGroup(
            jPanelColour091Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour091Layout.setVerticalGroup(
            jPanelColour091Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour091, new org.netbeans.lib.awtextra.AbsoluteConstraints(855, 201, 20, 20));

        jPanelColour090.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour090.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPanelColour090MouseClicked(evt);
            }
        });

        javax.swing.GroupLayout jPanelColour090Layout = new javax.swing.GroupLayout(jPanelColour090);
        jPanelColour090.setLayout(jPanelColour090Layout);
        jPanelColour090Layout.setHorizontalGroup(
            jPanelColour090Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );
        jPanelColour090Layout.setVerticalGroup(
            jPanelColour090Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 20, Short.MAX_VALUE)
        );

        jPanel5.add(jPanelColour090, new org.netbeans.lib.awtextra.AbsoluteConstraints(822, 201, 20, 20));
        ...
        jPanel5.add(jPanelColour089, new org.netbeans.lib.awtextra.AbsoluteConstraints(787, 200, 20, 20));
        ...
        jPanel5.add(jPanelColour088, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 196, 20, 30));
        ...
        jPanel5.add(jPanelColour087, new org.netbeans.lib.awtextra.AbsoluteConstraints(588, 202, 50, 20));
        ...
        jPanel5.add(jPanelColour086, new org.netbeans.lib.awtextra.AbsoluteConstraints(539, 201, 20, 20));
        ...
        jPanel5.add(jPanelColour085, new org.netbeans.lib.awtextra.AbsoluteConstraints(505, 202, 20, 20));
        ...
        jPanel5.add(jPanelColour084, new org.netbeans.lib.awtextra.AbsoluteConstraints(473, 202, 20, 20));
        ...
        jPanel5.add(jPanelColour083, new org.netbeans.lib.awtextra.AbsoluteConstraints(438, 202, 20, 20));
        ...
        jPanel5.add(jPanelColour082, new org.netbeans.lib.awtextra.AbsoluteConstraints(405, 202, 20, 20));
        ...
        jPanel5.add(jPanelColour081, new org.netbeans.lib.awtextra.AbsoluteConstraints(372, 202, 20, 20));
        ...
        jPanel5.add(jPanelColour080, new org.netbeans.lib.awtextra.AbsoluteConstraints(338, 201, 20, 20));
        ...
        jPanel5.add(jPanelColour079, new org.netbeans.lib.awtextra.AbsoluteConstraints(305, 202, 20, 20));
        ...
        jPanel5.add(jPanelColour078, new org.netbeans.lib.awtextra.AbsoluteConstraints(271, 202, 20, 20));
        ...
        jPanel5.add(jPanelColour077, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 202, 20, 20));
        ...
        jPanel5.add(jPanelColour076, new org.netbeans.lib.awtextra.AbsoluteConstraints(622, 134, 20, 20));
        ...
        jPanel5.add(jPanelColour075, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 202, 50, 20));
        ...
        jPanel5.add(jPanelColour074, new org.netbeans.lib.awtextra.AbsoluteConstraints(855, 168, 20, 20));
        ...
        jPanel5.add(jPanelColour073, new org.netbeans.lib.awtextra.AbsoluteConstraints(821, 165, 20, 20));
        ...
        jPanel5.add(jPanelColour072, new org.netbeans.lib.awtextra.AbsoluteConstraints(788, 168, 20, 20));

        jPanelColour071.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour071.setEnabled(false);
        ...
        jPanel5.add(jPanelColour071, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 170, 0, 10));
        ...
        jPanel5.add(jPanelColour070, new org.netbeans.lib.awtextra.AbsoluteConstraints(555, 168, 20, 20));
        ...
        jPanel5.add(jPanelColour069, new org.netbeans.lib.awtextra.AbsoluteConstraints(523, 167, 20, 20));
        ...
        jPanel5.add(jPanelColour068, new org.netbeans.lib.awtextra.AbsoluteConstraints(488, 168, 20, 20));
        ...
        jPanel5.add(jPanelColour067, new org.netbeans.lib.awtextra.AbsoluteConstraints(455, 168, 20, 20));
        ...
        jPanel5.add(jPanelColour066, new org.netbeans.lib.awtextra.AbsoluteConstraints(422, 168, 20, 20));
        ...
        jPanel5.add(jPanelColour065, new org.netbeans.lib.awtextra.AbsoluteConstraints(388, 168, 20, 20));
        ...
        jPanel5.add(jPanelColour064, new org.netbeans.lib.awtextra.AbsoluteConstraints(355, 168, 20, 20));
        ...
        jPanel5.add(jPanelColour063, new org.netbeans.lib.awtextra.AbsoluteConstraints(321, 168, 20, 20));
        ...
        jPanel5.add(jPanelColour062, new org.netbeans.lib.awtextra.AbsoluteConstraints(288, 162, 20, 30));
        ...
        jPanel5.add(jPanelColour061, new org.netbeans.lib.awtextra.AbsoluteConstraints(255, 162, 20, 30));
        ...
        jPanel5.add(jPanelColour060, new org.netbeans.lib.awtextra.AbsoluteConstraints(221, 162, 20, 30));
        ...
        jPanel5.add(jPanelColour059, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 168, 30, 20));
        ...
        jPanel5.add(jPanelColour058, new org.netbeans.lib.awtextra.AbsoluteConstraints(888, 135, 20, 50));
        ...
        jPanel5.add(jPanelColour057, new org.netbeans.lib.awtextra.AbsoluteConstraints(854, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour056, new org.netbeans.lib.awtextra.AbsoluteConstraints(822, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour055, new org.netbeans.lib.awtextra.AbsoluteConstraints(787, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour054, new org.netbeans.lib.awtextra.AbsoluteConstraints(744, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour053, new org.netbeans.lib.awtextra.AbsoluteConstraints(709, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour052, new org.netbeans.lib.awtextra.AbsoluteConstraints(676, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour051, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 167, 40, 20));
        ...
        jPanel5.add(jPanelColour050, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour049, new org.netbeans.lib.awtextra.AbsoluteConstraints(546, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour048, new org.netbeans.lib.awtextra.AbsoluteConstraints(513, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour047, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour046, new org.netbeans.lib.awtextra.AbsoluteConstraints(448, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour045, new org.netbeans.lib.awtextra.AbsoluteConstraints(413, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour044, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour043, new org.netbeans.lib.awtextra.AbsoluteConstraints(347, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour042, new org.netbeans.lib.awtextra.AbsoluteConstraints(312, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour041, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 135, 20, 20));
        ...
        jPanel5.add(jPanelColour040, new org.netbeans.lib.awtextra.AbsoluteConstraints(246, 129, 20, 30));
        ...
        jPanel5.add(jPanelColour039, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 134, 20, 20));
        ...
        jPanel5.add(jPanelColour038, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 20, 30));
        ...
        jPanel5.add(jPanelColour037, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 100, 20, 20));
        ...
        jPanel5.add(jPanelColour036, new org.netbeans.lib.awtextra.AbsoluteConstraints(857, 100, 20, 20));
        ...
        jPanel5.add(jPanelColour035, new org.netbeans.lib.awtextra.AbsoluteConstraints(824, 100, 20, 20));
        ...
        jPanel5.add(jPanelColour034, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 100, 20, 20));
        ...
        jPanel5.add(jPanelColour033, new org.netbeans.lib.awtextra.AbsoluteConstraints(743, 100, 20, 20));
        ...
        jPanel5.add(jPanelColour032, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 100, 20, 20));
        ...
        jPanel5.add(jPanelColour031, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 100, 30, 20));
        ...
        jPanel5.add(jPanelColour030, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 100, 50, 20));
        ...
        jPanel5.add(jPanelColour029, new org.netbeans.lib.awtextra.AbsoluteConstraints(564, 101, 20, 20));
        ...
        jPanel5.add(jPanelColour028, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 101, 20, 20));
        ...
        jPanel5.add(jPanelColour027, new org.netbeans.lib.awtextra.AbsoluteConstraints(498, 101, 20, 20));
        ...
        jPanel5.add(jPanelColour026, new org.netbeans.lib.awtextra.AbsoluteConstraints(462, 101, 20, 20));
        ...
        jPanel5.add(jPanelColour025, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 102, 20, 20));
        ...
        jPanel5.add(jPanelColour024, new org.netbeans.lib.awtextra.AbsoluteConstraints(397, 101, 20, 20));
        ...
        jPanel5.add(jPanelColour023, new org.netbeans.lib.awtextra.AbsoluteConstraints(363, 102, 20, 20));
        ...
        jPanel5.add(jPanelColour022, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 101, 20, 20));
        ...
        jPanel5.add(jPanelColour021, new org.netbeans.lib.awtextra.AbsoluteConstraints(297, 101, 20, 20));
        ...
        jPanel5.add(jPanelColour020, new org.netbeans.lib.awtextra.AbsoluteConstraints(263, 101, 20, 20));
        ...
        jPanel5.add(jPanelColour019, new org.netbeans.lib.awtextra.AbsoluteConstraints(228, 101, 20, 20));
        ...
        jPanel5.add(jPanelColour018, new org.netbeans.lib.awtextra.AbsoluteConstraints(197, 101, 20, 20));
        ...
        jPanel5.add(jPanelColour017, new org.netbeans.lib.awtextra.AbsoluteConstraints(162, 100, 20, 20));
        ...
        jPanel5.add(jPanelColour016, new org.netbeans.lib.awtextra.AbsoluteConstraints(744, 59, 20, 20));
        ...
        jPanel5.add(jPanelColour015, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 58, 20, 20));
        ...
        jPanel5.add(jPanelColour014, new org.netbeans.lib.awtextra.AbsoluteConstraints(677, 58, 22, 22));
        ...
        jPanel5.add(jPanelColour013, new org.netbeans.lib.awtextra.AbsoluteConstraints(632, 60, 20, 20));

        jPanelColour012.setBackground(new java.awt.Color(255, 255, 255));
        jPanelColour012.setPreferredSize(new java.awt.Dimension(20, 20));
        ...
        jPanel5.add(jPanelColour012, new org.netbeans.lib.awtextra.AbsoluteConstraints(598, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour011, new org.netbeans.lib.awtextra.AbsoluteConstraints(565, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour010, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour009, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour008, new org.netbeans.lib.awtextra.AbsoluteConstraints(441, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour007, new org.netbeans.lib.awtextra.AbsoluteConstraints(408, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour006, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour005, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour004, new org.netbeans.lib.awtextra.AbsoluteConstraints(284, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour003, new org.netbeans.lib.awtextra.AbsoluteConstraints(251, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour002, new org.netbeans.lib.awtextra.AbsoluteConstraints(218, 60, 20, 20));
        ...
        jPanel5.add(jPanelColour001, new org.netbeans.lib.awtextra.AbsoluteConstraints(162, 60, 20, 20));
        ...
        javax.swing.GroupLayout jPanelGKeysLayout = new javax.swing.GroupLayout(jPanelGKeys);
        jPanelGKeys.setLayout(jPanelGKeysLayout);
        jPanelGKeysLayout.setHorizontalGroup(
            jPanelGKeysLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 1114, Short.MAX_VALUE)
        );
        jPanelGKeysLayout.setVerticalGroup(
            jPanelGKeysLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 779, Short.MAX_VALUE)
        );

        jTabbedPane1.addTab("G Keys", jPanelGKeys);
        ...
        if (!resettingEffect) {
            switch (selectedIndex) {
                ...
                case 5:
                    ...
                    jLayeredPane1.moveToBack(jPanelColour115);
                    jPanelColour116.setBackground(initialStar);
                    jLayeredPane1.moveToBack(jPanelColour116);
    ...
    private void jPanelColour116MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour116MouseClicked
        selectedButton = "116";
        selectedButtonText = "G_BADGE";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour116MouseClicked

    private void jPanelColour115MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour115MouseClicked
        selectedButton = "115";
        selectedButtonText = "G_LOGO";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour115MouseClicked

    private void jPanelColour114MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour114MouseClicked
        selectedButton = "114";
        selectedButtonText = "G_9";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour114MouseClicked

    private void jPanelColour113MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour113MouseClicked
        selectedButton = "113";
        selectedButtonText = "G_8";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour113MouseClicked

    private void jPanelColour112MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour112MouseClicked
        selectedButton = "112";
        selectedButtonText = "G_7";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour112MouseClicked

    private void jPanelColour111MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour111MouseClicked
        selectedButton = "111";
        selectedButtonText = "G_6";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour111MouseClicked

    private void jPanelColour110MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour110MouseClicked
        selectedButton = "110";
        selectedButtonText = "G_5";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour110MouseClicked

    private void jPanelColour109MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour109MouseClicked
        selectedButton = "109";
        selectedButtonText = "G_4";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour109MouseClicked

    private void jPanelColour108MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour108MouseClicked
        selectedButton = "108";
        selectedButtonText = "G_3";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour108MouseClicked

    private void jPanelColour107MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour107MouseClicked
        selectedButton = "107";
        selectedButtonText = "G_2";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour107MouseClicked

    private void jPanelColour106MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour106MouseClicked
        selectedButton = "106";
        selectedButtonText = "G_1";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour106MouseClicked

    private void jPanelColour105MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour105MouseClicked
        selectedButton = "105";
        selectedButtonText = "NUM_PERIOD";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour105MouseClicked

    private void jPanelColour104MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour104MouseClicked
        selectedButton = "104";
        selectedButtonText = "NUM_ZERO";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour104MouseClicked

    private void jPanelColour103MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour103MouseClicked
        selectedButton = "103";
        selectedButtonText = "ARROW_RIGHT";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour103MouseClicked

    private void jPanelColour102MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour102MouseClicked
        selectedButton = "102";
        selectedButtonText = "ARROW_DOWN";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour102MouseClicked

    private void jPanelColour101MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour101MouseClicked
        selectedButton = "101";
        selectedButtonText = "ARROW_LEFT";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour101MouseClicked

    private void jPanelColour100MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour100MouseClicked
        selectedButton = "100";
        selectedButtonText = "RIGHT_CONTROL";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour100MouseClicked

    private void jPanelColour099MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour099MouseClicked
        selectedButton = "099";
        selectedButtonText = "APPLICATION_SELECT";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour099MouseClicked

    private void jPanelColour098MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour098MouseClicked
        selectedButton = "098";
        selectedButtonText = "RIGHT_WINDOWS";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour098MouseClicked

    private void jPanelColour097MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour097MouseClicked
        selectedButton = "097";
        selectedButtonText = "RIGHT_ALT";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour097MouseClicked

    private void jPanelColour096MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour096MouseClicked
        selectedButton = "096";
        selectedButtonText = "SPACE";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour096MouseClicked

    private void jPanelColour095MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour095MouseClicked
        selectedButton = "095";
        selectedButtonText = "LEFT_ALT";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour095MouseClicked

    private void jPanelColour094MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour094MouseClicked
        selectedButton = "094";
        selectedButtonText = "LEFT_WINDOWS";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour094MouseClicked

    private void jPanelColour093MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour093MouseClicked
        selectedButton = "093";
        selectedButtonText = "LEFT_CONTROL";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour093MouseClicked

    private void jPanelColour092MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour092MouseClicked
        selectedButton = "092";
        selectedButtonText = "NUM_ENTER";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour092MouseClicked

    private void jPanelColour091MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour091MouseClicked
        selectedButton = "091";
        selectedButtonText = "NUM_THREE";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour091MouseClicked

    private void jPanelColour090MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour090MouseClicked
        selectedButton = "090";
        selectedButtonText = "NUM_TWO";
        jLabelSelectedButton.setText(selectedButtonText);
    }//GEN-LAST:event_jPanelColour090MouseClicked

    private void jPanelColour089MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour089MouseClicked
        selectedButton = "089";
        selectedButtonText = "NUM_ONE";
        jLabelSelectedButton.setText(selectedButtonText);
    ...
    private void jPanelColour071MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour071MouseClicked
        /*selectedButton = "071";
        selectedButtonText = "HASH";//UK Layout
        jLabelSelectedButton.setText(selectedButtonText);*/
    ...
    private void jPanelColour036MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelColour036MouseClicked
        selectedButton = "036";
        selectedButtonText = "NUM_ASTERISK";
        jLabelSelectedButton.setText(selectedButtonText);
    ...
    private void jButtonLoadProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoadProfileActionPerformed
        GKeyboard tmpGKeyboard = IOOperations.loadProfile(Keyboard.KeyboardModel.Logi910SparkUSQWERTY);
    ...
    private void jButtonSaveProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveProfileActionPerformed
        gKeyboard.setKeyColourMap(convertG910ColourMapToStandardKeyColourMap(getColoursFromVirtualKeyboard()));
    ...
    public javax.swing.JPanel jPanelColour090;
    public javax.swing.JPanel jPanelColour091;
    public javax.swing.JPanel jPanelColour092;
    public javax.swing.JPanel jPanelColour093;
    public javax.swing.JPanel jPanelColour094;
    public javax.swing.JPanel jPanelColour095;
    public javax.swing.JPanel jPanelColour096;
    public javax.swing.JPanel jPanelColour097;
    public javax.swing.JPanel jPanelColour098;
    public javax.swing.JPanel jPanelColour099;
    public javax.swing.JPanel jPanelColour100;
    public javax.swing.JPanel jPanelColour101;
    public javax.swing.JPanel jPanelColour102;
    public javax.swing.JPanel jPanelColour103;
    public javax.swing.JPanel jPanelColour104;
    public javax.swing.JPanel jPanelColour105;
    public javax.swing.JPanel jPanelColour106;
    public javax.swing.JPanel jPanelColour107;
    public javax.swing.JPanel jPanelColour108;
    public javax.swing.JPanel jPanelColour109;
    public javax.swing.JPanel jPanelColour110;
    public javax.swing.JPanel jPanelColour111;
    public javax.swing.JPanel jPanelColour112;
    public javax.swing.JPanel jPanelColour113;
    public javax.swing.JPanel jPanelColour114;
    public javax.swing.JPanel jPanelColour115;
    public javax.swing.JPanel jPanelColour116;
    ...
    private javax.swing.JPanel jPanelGKeys;
                    ...
                    case Stars:
                        if (gKeyboard.getStarEffect() != null) {
                            ...
                            try {
                                ...
                                Logger.getLogger(G910SparkUSQWERTY.class.getName()).log(Level.SEVERE, null, ex);
                            }
    ...
    private void startStarEffect(String starColour, String skyColour) {
        ...
        gKeyboard.getStarEffect().setKeyboardModel(Keyboard.KeyboardModel.Logi910SparkUSQWERTY);
    ...
    private JPanel[] getKeyboardJPanels() {
        ...
        keyboardJPanel[89] = jPanelColour090;
        keyboardJPanel[90] = jPanelColour091;
        keyboardJPanel[91] = jPanelColour092;
        keyboardJPanel[92] = jPanelColour093;
        keyboardJPanel[93] = jPanelColour094;
        keyboardJPanel[94] = jPanelColour095;
        keyboardJPanel[95] = jPanelColour096;
        keyboardJPanel[96] = jPanelColour097;
        keyboardJPanel[97] = jPanelColour098;
        keyboardJPanel[98] = jPanelColour099;
        keyboardJPanel[99] = jPanelColour100;
        keyboardJPanel[100] = jPanelColour101;
        keyboardJPanel[101] = jPanelColour102;
        keyboardJPanel[102] = jPanelColour103;
        keyboardJPanel[103] = jPanelColour104;
        keyboardJPanel[104] = jPanelColour105;
        keyboardJPanel[105] = jPanelColour106;
        keyboardJPanel[106] = jPanelColour107;
        keyboardJPanel[107] = jPanelColour108;
        keyboardJPanel[108] = jPanelColour109;
        keyboardJPanel[109] = jPanelColour110;
        keyboardJPanel[110] = jPanelColour111;
        keyboardJPanel[111] = jPanelColour112;
        keyboardJPanel[112] = jPanelColour113;
        keyboardJPanel[113] = jPanelColour114;
        keyboardJPanel[114] = jPanelColour115;
        keyboardJPanel[115] = jPanelColour116;
    ...
    private JPanel[][] getKeyboardColourWaveJPanels(Effects.ColourWaveType type) {
        switch (type) {
            case Horizontal:
            default:
                JPanel[][] keyboardJPanelHorizontal = new JPanel[22][];
                keyboardJPanelHorizontal[0] = new JPanel[6];
                keyboardJPanelHorizontal[1] = new JPanel[6];
                keyboardJPanelHorizontal[2] = new JPanel[6];
                keyboardJPanelHorizontal[3] = new JPanel[7];
                keyboardJPanelHorizontal[4] = new JPanel[7];
                keyboardJPanelHorizontal[5] = new JPanel[6];
                keyboardJPanelHorizontal[6] = new JPanel[4];
                keyboardJPanelHorizontal[7] = new JPanel[6];
                keyboardJPanelHorizontal[8] = new JPanel[5];
                keyboardJPanelHorizontal[9] = new JPanel[5];
                keyboardJPanelHorizontal[10] = new JPanel[6];
                keyboardJPanelHorizontal[11] = new JPanel[5];
                keyboardJPanelHorizontal[12] = new JPanel[6];
                keyboardJPanelHorizontal[13] = new JPanel[5];
                keyboardJPanelHorizontal[14] = new JPanel[6];
                keyboardJPanelHorizontal[15] = new JPanel[4];
                keyboardJPanelHorizontal[16] = new JPanel[5];
                keyboardJPanelHorizontal[17] = new JPanel[4];
                keyboardJPanelHorizontal[18] = new JPanel[5];
                keyboardJPanelHorizontal[19] = new JPanel[4];
                keyboardJPanelHorizontal[20] = new JPanel[5];
                keyboardJPanelHorizontal[21] = new JPanel[3];
                keyboardJPanelHorizontal[0][0] = jPanelColour115;
                keyboardJPanelHorizontal[0][1] = jPanelColour106;
                keyboardJPanelHorizontal[0][2] = jPanelColour107;
                keyboardJPanelHorizontal[0][3] = jPanelColour108;
                keyboardJPanelHorizontal[0][4] = jPanelColour109;
                keyboardJPanelHorizontal[0][5] = jPanelColour110;
                keyboardJPanelHorizontal[1][0] = jPanelColour001;
                keyboardJPanelHorizontal[1][1] = jPanelColour017;
                keyboardJPanelHorizontal[1][2] = jPanelColour038;
                keyboardJPanelHorizontal[1][3] = jPanelColour059;
                keyboardJPanelHorizontal[1][4] = jPanelColour075;
                keyboardJPanelHorizontal[1][5] = jPanelColour093;
                keyboardJPanelHorizontal[2][0] = jPanelColour111;
                keyboardJPanelHorizontal[2][1] = jPanelColour002;
                keyboardJPanelHorizontal[2][2] = jPanelColour018;
                keyboardJPanelHorizontal[2][3] = jPanelColour039;
                keyboardJPanelHorizontal[2][4] = jPanelColour060;
                keyboardJPanelHorizontal[2][5] = jPanelColour094;
                //keyboardJPanelHorizontal[2][6] = jPanelColour076;
                keyboardJPanelHorizontal[3][0] = jPanelColour112;
                keyboardJPanelHorizontal[3][1] = jPanelColour003;
                keyboardJPanelHorizontal[3][2] = jPanelColour019;
                keyboardJPanelHorizontal[3][3] = jPanelColour040;
                keyboardJPanelHorizontal[3][4] = jPanelColour061;
                keyboardJPanelHorizontal[3][5] = jPanelColour077;
                keyboardJPanelHorizontal[3][6] = jPanelColour095;
                keyboardJPanelHorizontal[4][0] = jPanelColour113;
                keyboardJPanelHorizontal[4][1] = jPanelColour004;
                keyboardJPanelHorizontal[4][2] = jPanelColour020;
                keyboardJPanelHorizontal[4][3] = jPanelColour041;
                keyboardJPanelHorizontal[4][4] = jPanelColour062;
                keyboardJPanelHorizontal[4][5] = jPanelColour078;
                keyboardJPanelHorizontal[4][6] = jPanelColour116;
                keyboardJPanelHorizontal[5][0] = jPanelColour114;
                keyboardJPanelHorizontal[5][1] = jPanelColour005;
                keyboardJPanelHorizontal[5][2] = jPanelColour021;
                keyboardJPanelHorizontal[5][3] = jPanelColour042;
                keyboardJPanelHorizontal[5][4] = jPanelColour063;
                keyboardJPanelHorizontal[5][5] = jPanelColour079;
                keyboardJPanelHorizontal[6][0] = jPanelColour022;
                keyboardJPanelHorizontal[6][1] = jPanelColour043;
                keyboardJPanelHorizontal[6][2] = jPanelColour064;
                keyboardJPanelHorizontal[6][3] = jPanelColour080;
                keyboardJPanelHorizontal[7][0] = jPanelColour006;
                keyboardJPanelHorizontal[7][1] = jPanelColour023;
                keyboardJPanelHorizontal[7][2] = jPanelColour044;
                keyboardJPanelHorizontal[7][3] = jPanelColour065;
                keyboardJPanelHorizontal[7][4] = jPanelColour081;
                keyboardJPanelHorizontal[7][5] = jPanelColour096;
                keyboardJPanelHorizontal[8][0] = jPanelColour007;
                keyboardJPanelHorizontal[8][1] = jPanelColour024;
                keyboardJPanelHorizontal[8][2] = jPanelColour045;
                keyboardJPanelHorizontal[8][3] = jPanelColour066;
                keyboardJPanelHorizontal[8][4] = jPanelColour082;
                keyboardJPanelHorizontal[9][0] = jPanelColour008;
                keyboardJPanelHorizontal[9][1] = jPanelColour025;
                keyboardJPanelHorizontal[9][2] = jPanelColour046;
                keyboardJPanelHorizontal[9][3] = jPanelColour067;
                keyboardJPanelHorizontal[9][4] = jPanelColour083;
                keyboardJPanelHorizontal[10][0] = jPanelColour009;
                keyboardJPanelHorizontal[10][1] = jPanelColour026;
                keyboardJPanelHorizontal[10][2] = jPanelColour047;
                keyboardJPanelHorizontal[10][3] = jPanelColour068;
                keyboardJPanelHorizontal[10][4] = jPanelColour084;
                keyboardJPanelHorizontal[10][5] = jPanelColour097;
                keyboardJPanelHorizontal[11][0] = jPanelColour027;
                keyboardJPanelHorizontal[11][1] = jPanelColour048;
                keyboardJPanelHorizontal[11][2] = jPanelColour069;
                keyboardJPanelHorizontal[11][3] = jPanelColour085;
                keyboardJPanelHorizontal[11][4] = jPanelColour098;
                keyboardJPanelHorizontal[12][0] = jPanelColour010;
                keyboardJPanelHorizontal[12][1] = jPanelColour028;
                keyboardJPanelHorizontal[12][2] = jPanelColour049;
                keyboardJPanelHorizontal[12][3] = jPanelColour070;
                keyboardJPanelHorizontal[12][4] = jPanelColour086;
                keyboardJPanelHorizontal[12][5] = jPanelColour099;
                keyboardJPanelHorizontal[13][0] = jPanelColour011;
                keyboardJPanelHorizontal[13][1] = jPanelColour029;
                keyboardJPanelHorizontal[13][2] = jPanelColour050;
                keyboardJPanelHorizontal[13][3] = jPanelColour076;
                keyboardJPanelHorizontal[13][4] = jPanelColour071;
                keyboardJPanelHorizontal[14][0] = jPanelColour012;
                keyboardJPanelHorizontal[14][1] = jPanelColour013;
                keyboardJPanelHorizontal[14][2] = jPanelColour030;
                keyboardJPanelHorizontal[14][3] = jPanelColour051;
                keyboardJPanelHorizontal[14][4] = jPanelColour087;
                keyboardJPanelHorizontal[14][5] = jPanelColour100;
                keyboardJPanelHorizontal[15][0] = jPanelColour014;
                keyboardJPanelHorizontal[15][1] = jPanelColour031;
                keyboardJPanelHorizontal[15][2] = jPanelColour052;
                keyboardJPanelHorizontal[15][3] = jPanelColour101;
                keyboardJPanelHorizontal[16][0] = jPanelColour015;
                keyboardJPanelHorizontal[16][1] = jPanelColour032;
                keyboardJPanelHorizontal[16][2] = jPanelColour053;
                keyboardJPanelHorizontal[16][3] = jPanelColour088;
                keyboardJPanelHorizontal[16][4] = jPanelColour102;
                keyboardJPanelHorizontal[17][0] = jPanelColour016;
                keyboardJPanelHorizontal[17][1] = jPanelColour033;
                keyboardJPanelHorizontal[17][2] = jPanelColour054;
                keyboardJPanelHorizontal[17][3] = jPanelColour103;
                keyboardJPanelHorizontal[18][0] = jPanelColour034;
                keyboardJPanelHorizontal[18][1] = jPanelColour055;
                keyboardJPanelHorizontal[18][2] = jPanelColour072;
                keyboardJPanelHorizontal[18][3] = jPanelColour089;
                keyboardJPanelHorizontal[18][4] = jPanelColour104;
                keyboardJPanelHorizontal[19][0] = jPanelColour035;
                keyboardJPanelHorizontal[19][1] = jPanelColour056;
                keyboardJPanelHorizontal[19][2] = jPanelColour073;
                keyboardJPanelHorizontal[19][3] = jPanelColour090;
                keyboardJPanelHorizontal[20][0] = jPanelColour036;
                keyboardJPanelHorizontal[20][1] = jPanelColour057;
                keyboardJPanelHorizontal[20][2] = jPanelColour074;
                keyboardJPanelHorizontal[20][3] = jPanelColour091;
                keyboardJPanelHorizontal[20][4] = jPanelColour105;
                keyboardJPanelHorizontal[21][0] = jPanelColour037;
                keyboardJPanelHorizontal[21][1] = jPanelColour058;
                keyboardJPanelHorizontal[21][2] = jPanelColour092;
                return keyboardJPanelHorizontal;
            case Vertical:
                JPanel[][] keyboardJPanelVertical = new JPanel[8][];
                keyboardJPanelVertical[0] = new JPanel[4];
                keyboardJPanelVertical[1] = new JPanel[17];
                keyboardJPanelVertical[2] = new JPanel[22];
                keyboardJPanelVertical[3] = new JPanel[23];
                keyboardJPanelVertical[4] = new JPanel[17];
                keyboardJPanelVertical[5] = new JPanel[18];
                keyboardJPanelVertical[6] = new JPanel[14];
                keyboardJPanelVertical[7] = new JPanel[1];
                keyboardJPanelVertical[0][0] = jPanelColour111;
                keyboardJPanelVertical[0][1] = jPanelColour112;
                keyboardJPanelVertical[0][2] = jPanelColour113;
                keyboardJPanelVertical[0][3] = jPanelColour114;
                keyboardJPanelVertical[1][0] = jPanelColour115;
                keyboardJPanelVertical[1][1] = jPanelColour001;
                keyboardJPanelVertical[1][2] = jPanelColour002;
                keyboardJPanelVertical[1][3] = jPanelColour003;
                keyboardJPanelVertical[1][4] = jPanelColour004;
                keyboardJPanelVertical[1][5] = jPanelColour005;
                keyboardJPanelVertical[1][6] = jPanelColour006;
                keyboardJPanelVertical[1][7] = jPanelColour007;
                keyboardJPanelVertical[1][8] = jPanelColour008;
                keyboardJPanelVertical[1][9] = jPanelColour009;
                keyboardJPanelVertical[1][10] = jPanelColour010;
                keyboardJPanelVertical[1][11] = jPanelColour011;
                keyboardJPanelVertical[1][12] = jPanelColour012;
                keyboardJPanelVertical[1][13] = jPanelColour013;
                keyboardJPanelVertical[1][14] = jPanelColour014;
                keyboardJPanelVertical[1][15] = jPanelColour015;
                keyboardJPanelVertical[1][16] = jPanelColour016;
                keyboardJPanelVertical[2][0] = jPanelColour106;
                keyboardJPanelVertical[2][1] = jPanelColour017;
                keyboardJPanelVertical[2][2] = jPanelColour018;
                keyboardJPanelVertical[2][3] = jPanelColour019;
                keyboardJPanelVertical[2][4] = jPanelColour020;
                keyboardJPanelVertical[2][5] = jPanelColour021;
                keyboardJPanelVertical[2][6] = jPanelColour022;
                keyboardJPanelVertical[2][7] = jPanelColour023;
                keyboardJPanelVertical[2][8] = jPanelColour024;
                keyboardJPanelVertical[2][9] = jPanelColour025;
                keyboardJPanelVertical[2][10] = jPanelColour026;
                keyboardJPanelVertical[2][11] = jPanelColour027;
                keyboardJPanelVertical[2][12] = jPanelColour028;
                keyboardJPanelVertical[2][13] = jPanelColour029;
                keyboardJPanelVertical[2][14] = jPanelColour030;
                keyboardJPanelVertical[2][15] = jPanelColour031;
                keyboardJPanelVertical[2][16] = jPanelColour032;
                keyboardJPanelVertical[2][17] = jPanelColour033;
                keyboardJPanelVertical[2][18] = jPanelColour034;
                keyboardJPanelVertical[2][19] = jPanelColour035;
                keyboardJPanelVertical[2][20] = jPanelColour036;
                keyboardJPanelVertical[2][21] = jPanelColour037;
                keyboardJPanelVertical[3][0] = jPanelColour107;
                keyboardJPanelVertical[3][1] = jPanelColour038;
                keyboardJPanelVertical[3][2] = jPanelColour039;
                keyboardJPanelVertical[3][3] = jPanelColour040;
                keyboardJPanelVertical[3][4] = jPanelColour041;
                keyboardJPanelVertical[3][5] = jPanelColour042;
                keyboardJPanelVertical[3][6] = jPanelColour043;
                keyboardJPanelVertical[3][7] = jPanelColour044;
                keyboardJPanelVertical[3][8] = jPanelColour045;
                keyboardJPanelVertical[3][9] = jPanelColour046;
                keyboardJPanelVertical[3][10] = jPanelColour047;
                keyboardJPanelVertical[3][11] = jPanelColour048;
                keyboardJPanelVertical[3][12] = jPanelColour049;
                keyboardJPanelVertical[3][13] = jPanelColour050;
                keyboardJPanelVertical[3][14] = jPanelColour076;
                keyboardJPanelVertical[3][15] = jPanelColour051;
                keyboardJPanelVertical[3][16] = jPanelColour052;
                keyboardJPanelVertical[3][17] = jPanelColour053;
                keyboardJPanelVertical[3][18] = jPanelColour054;
                keyboardJPanelVertical[3][19] = jPanelColour055;
                keyboardJPanelVertical[3][20] = jPanelColour056;
                keyboardJPanelVertical[3][21] = jPanelColour057;
                keyboardJPanelVertical[3][22] = jPanelColour058;
                keyboardJPanelVertical[4][0] = jPanelColour108;
                keyboardJPanelVertical[4][1] = jPanelColour059;
                keyboardJPanelVertical[4][2] = jPanelColour060;
                keyboardJPanelVertical[4][3] = jPanelColour061;
                keyboardJPanelVertical[4][4] = jPanelColour062;
                keyboardJPanelVertical[4][5] = jPanelColour063;
                keyboardJPanelVertical[4][6] = jPanelColour064;
                keyboardJPanelVertical[4][7] = jPanelColour065;
                keyboardJPanelVertical[4][8] = jPanelColour066;
                keyboardJPanelVertical[4][9] = jPanelColour067;
                keyboardJPanelVertical[4][10] = jPanelColour068;
                keyboardJPanelVertical[4][11] = jPanelColour069;
                keyboardJPanelVertical[4][12] = jPanelColour070;
                keyboardJPanelVertical[4][13] = jPanelColour071;
                keyboardJPanelVertical[4][14] = jPanelColour072;
                keyboardJPanelVertical[4][15] = jPanelColour073;
                keyboardJPanelVertical[4][16] = jPanelColour074;
                keyboardJPanelVertical[5][0] = jPanelColour109;
                keyboardJPanelVertical[5][1] = jPanelColour075;
                //keyboardJPanelVertical[5][2] = jPanelColour076;
                keyboardJPanelVertical[5][2] = jPanelColour077;
                keyboardJPanelVertical[5][3] = jPanelColour078;
                keyboardJPanelVertical[5][4] = jPanelColour079;
                keyboardJPanelVertical[5][5] = jPanelColour080;
                keyboardJPanelVertical[5][6] = jPanelColour081;
                keyboardJPanelVertical[5][7] = jPanelColour082;
                keyboardJPanelVertical[5][8] = jPanelColour083;
                keyboardJPanelVertical[5][9] = jPanelColour084;
                keyboardJPanelVertical[5][10] = jPanelColour085;
                keyboardJPanelVertical[5][11] = jPanelColour086;
                keyboardJPanelVertical[5][12] = jPanelColour087;
                keyboardJPanelVertical[5][13] = jPanelColour088;
                keyboardJPanelVertical[5][14] = jPanelColour089;
                keyboardJPanelVertical[5][15] = jPanelColour090;
                keyboardJPanelVertical[5][16] = jPanelColour091;
                keyboardJPanelVertical[5][17] = jPanelColour092;
                keyboardJPanelVertical[6][0] = jPanelColour110;
                keyboardJPanelVertical[6][1] = jPanelColour093;
                keyboardJPanelVertical[6][2] = jPanelColour094;
                keyboardJPanelVertical[6][3] = jPanelColour095;
                keyboardJPanelVertical[6][4] = jPanelColour096;
                keyboardJPanelVertical[6][5] = jPanelColour097;
                keyboardJPanelVertical[6][6] = jPanelColour098;
                keyboardJPanelVertical[6][7] = jPanelColour099;
                keyboardJPanelVertical[6][8] = jPanelColour100;
                keyboardJPanelVertical[6][9] = jPanelColour101;
                keyboardJPanelVertical[6][10] = jPanelColour102;
                keyboardJPanelVertical[6][11] = jPanelColour103;
                keyboardJPanelVertical[6][12] = jPanelColour104;
                keyboardJPanelVertical[6][13] = jPanelColour105;
                keyboardJPanelVertical[7][0] = jPanelColour116;
                return keyboardJPanelVertical;
            case CentreOut:
                JPanel[][] keyboardJPanelCentreOut = new JPanel[11][];
                keyboardJPanelCentreOut[0] = new JPanel[3];
                keyboardJPanelCentreOut[1] = new JPanel[9];
                keyboardJPanelCentreOut[2] = new JPanel[17];
                keyboardJPanelCentreOut[3] = new JPanel[11];
                keyboardJPanelCentreOut[4] = new JPanel[8];
                keyboardJPanelCentreOut[5] = new JPanel[9];
                keyboardJPanelCentreOut[6] = new JPanel[10];
                keyboardJPanelCentreOut[7] = new JPanel[19];
                keyboardJPanelCentreOut[8] = new JPanel[10];
                keyboardJPanelCentreOut[9] = new JPanel[11];
                keyboardJPanelCentreOut[10] = new JPanel[9];
                keyboardJPanelCentreOut[0][0] = jPanelColour047;
                keyboardJPanelCentreOut[0][1] = jPanelColour048;
                keyboardJPanelCentreOut[0][2] = jPanelColour068;
                keyboardJPanelCentreOut[1][0] = jPanelColour046;
                keyboardJPanelCentreOut[1][1] = jPanelColour067;
                keyboardJPanelCentreOut[1][2] = jPanelColour084;
                keyboardJPanelCentreOut[1][3] = jPanelColour085;
                keyboardJPanelCentreOut[1][4] = jPanelColour069;
                keyboardJPanelCentreOut[1][5] = jPanelColour049;
                keyboardJPanelCentreOut[1][6] = jPanelColour028;
                keyboardJPanelCentreOut[1][7] = jPanelColour027;
                keyboardJPanelCentreOut[1][8] = jPanelColour026;
                keyboardJPanelCentreOut[2][0] = jPanelColour025;
                keyboardJPanelCentreOut[2][1] = jPanelColour045;
                keyboardJPanelCentreOut[2][2] = jPanelColour066;
                keyboardJPanelCentreOut[2][3] = jPanelColour083;
                keyboardJPanelCentreOut[2][4] = jPanelColour097;
                keyboardJPanelCentreOut[2][5] = jPanelColour086;
                keyboardJPanelCentreOut[2][6] = jPanelColour070;
                keyboardJPanelCentreOut[2][7] = jPanelColour098;
                keyboardJPanelCentreOut[2][8] = jPanelColour099;
                keyboardJPanelCentreOut[2][9] = jPanelColour071;
                keyboardJPanelCentreOut[2][10] = jPanelColour050;
                keyboardJPanelCentreOut[2][11] = jPanelColour076;
                keyboardJPanelCentreOut[2][12] = jPanelColour029;
                keyboardJPanelCentreOut[2][13] = jPanelColour008;
                keyboardJPanelCentreOut[2][14] = jPanelColour009;
                keyboardJPanelCentreOut[2][15] = jPanelColour010;
                keyboardJPanelCentreOut[2][16] = jPanelColour011;
                keyboardJPanelCentreOut[3][0] = jPanelColour030;
                keyboardJPanelCentreOut[3][1] = jPanelColour051;
                keyboardJPanelCentreOut[3][2] = jPanelColour087;
                keyboardJPanelCentreOut[3][3] = jPanelColour100;
                keyboardJPanelCentreOut[3][4] = jPanelColour024;
                keyboardJPanelCentreOut[3][5] = jPanelColour044;
                keyboardJPanelCentreOut[3][6] = jPanelColour065;
                keyboardJPanelCentreOut[3][7] = jPanelColour082;
                keyboardJPanelCentreOut[3][8] = jPanelColour007;
                keyboardJPanelCentreOut[3][9] = jPanelColour012;
                keyboardJPanelCentreOut[3][10] = jPanelColour013;
                keyboardJPanelCentreOut[4][0] = jPanelColour023;
                keyboardJPanelCentreOut[4][1] = jPanelColour081;
                keyboardJPanelCentreOut[4][2] = jPanelColour096;
                keyboardJPanelCentreOut[4][3] = jPanelColour006;
                keyboardJPanelCentreOut[4][4] = jPanelColour014;
                keyboardJPanelCentreOut[4][5] = jPanelColour031;
                keyboardJPanelCentreOut[4][6] = jPanelColour052;
                keyboardJPanelCentreOut[4][7] = jPanelColour101;
                keyboardJPanelCentreOut[5][0] = jPanelColour022;
                keyboardJPanelCentreOut[5][1] = jPanelColour043;
                keyboardJPanelCentreOut[5][2] = jPanelColour064;
                keyboardJPanelCentreOut[5][3] = jPanelColour080;
                keyboardJPanelCentreOut[5][4] = jPanelColour015;
                keyboardJPanelCentreOut[5][5] = jPanelColour032;
                keyboardJPanelCentreOut[5][6] = jPanelColour053;
                keyboardJPanelCentreOut[5][7] = jPanelColour088;
                keyboardJPanelCentreOut[5][8] = jPanelColour102;
                keyboardJPanelCentreOut[6][0] = jPanelColour114;
                keyboardJPanelCentreOut[6][1] = jPanelColour005;
                keyboardJPanelCentreOut[6][2] = jPanelColour021;
                keyboardJPanelCentreOut[6][3] = jPanelColour042;
                keyboardJPanelCentreOut[6][4] = jPanelColour063;
                keyboardJPanelCentreOut[6][5] = jPanelColour079;
                keyboardJPanelCentreOut[6][6] = jPanelColour016;
                keyboardJPanelCentreOut[6][7] = jPanelColour033;
                keyboardJPanelCentreOut[6][8] = jPanelColour054;
                keyboardJPanelCentreOut[6][9] = jPanelColour103;
                keyboardJPanelCentreOut[7][0] = jPanelColour113;
                keyboardJPanelCentreOut[7][1] = jPanelColour004;
                keyboardJPanelCentreOut[7][2] = jPanelColour020;
                keyboardJPanelCentreOut[7][3] = jPanelColour041;
                keyboardJPanelCentreOut[7][4] = jPanelColour062;
                keyboardJPanelCentreOut[7][5] = jPanelColour078;
                keyboardJPanelCentreOut[7][6] = jPanelColour116;
                keyboardJPanelCentreOut[7][7] = jPanelColour034;
                keyboardJPanelCentreOut[7][8] = jPanelColour055;
                keyboardJPanelCentreOut[7][9] = jPanelColour072;
                keyboardJPanelCentreOut[7][10] = jPanelColour089;
                keyboardJPanelCentreOut[7][11] = jPanelColour104;
                keyboardJPanelCentreOut[7][12] = jPanelColour112;
                keyboardJPanelCentreOut[7][13] = jPanelColour003;
                keyboardJPanelCentreOut[7][14] = jPanelColour019;
                keyboardJPanelCentreOut[7][15] = jPanelColour040;
                keyboardJPanelCentreOut[7][16] = jPanelColour061;
                keyboardJPanelCentreOut[7][17] = jPanelColour077;
                keyboardJPanelCentreOut[7][18] = jPanelColour095;
                keyboardJPanelCentreOut[8][0] = jPanelColour111;
                keyboardJPanelCentreOut[8][1] = jPanelColour002;
                keyboardJPanelCentreOut[8][2] = jPanelColour018;
                keyboardJPanelCentreOut[8][3] = jPanelColour039;
                keyboardJPanelCentreOut[8][4] = jPanelColour060;
                //keyboardJPanelCentreOut[8][5] = jPanelColour076;
                keyboardJPanelCentreOut[8][5] = jPanelColour094;
                keyboardJPanelCentreOut[8][6] = jPanelColour035;
                keyboardJPanelCentreOut[8][7] = jPanelColour056;
                keyboardJPanelCentreOut[8][8] = jPanelColour073;
                keyboardJPanelCentreOut[8][9] = jPanelColour090;
                keyboardJPanelCentreOut[9][0] = jPanelColour001;
                keyboardJPanelCentreOut[9][1] = jPanelColour017;
                keyboardJPanelCentreOut[9][2] = jPanelColour038;
                keyboardJPanelCentreOut[9][3] = jPanelColour059;
                keyboardJPanelCentreOut[9][4] = jPanelColour075;
                keyboardJPanelCentreOut[9][5] = jPanelColour093;
                keyboardJPanelCentreOut[9][6] = jPanelColour036;
                keyboardJPanelCentreOut[9][7] = jPanelColour057;
                keyboardJPanelCentreOut[9][8] = jPanelColour074;
                keyboardJPanelCentreOut[9][9] = jPanelColour091;
                keyboardJPanelCentreOut[9][10] = jPanelColour105;
                keyboardJPanelCentreOut[10][0] = jPanelColour115;
                keyboardJPanelCentreOut[10][1] = jPanelColour106;
                keyboardJPanelCentreOut[10][2] = jPanelColour107;
                keyboardJPanelCentreOut[10][3] = jPanelColour108;
                keyboardJPanelCentreOut[10][4] = jPanelColour109;
                keyboardJPanelCentreOut[10][5] = jPanelColour110;
                keyboardJPanelCentreOut[10][6] = jPanelColour037;
                keyboardJPanelCentreOut[10][7] = jPanelColour058;
                keyboardJPanelCentreOut[10][8] = jPanelColour092;
    ...
    public void loadColoursToVirtualKeyboard(String[] colours) {
        ...
        jLayeredPane1.moveToBack(jPanelColour089);
        jPanelColour090.setBackground(IOOperations.getColourFromHexString(colours[89]));
        jLayeredPane1.moveToBack(jPanelColour090);
        jPanelColour091.setBackground(IOOperations.getColourFromHexString(colours[90]));
        jLayeredPane1.moveToBack(jPanelColour091);
        jPanelColour092.setBackground(IOOperations.getColourFromHexString(colours[91]));
        jLayeredPane1.moveToBack(jPanelColour092);
        jPanelColour093.setBackground(IOOperations.getColourFromHexString(colours[92]));
        jLayeredPane1.moveToBack(jPanelColour093);
        jPanelColour094.setBackground(IOOperations.getColourFromHexString(colours[93]));
        jLayeredPane1.moveToBack(jPanelColour094);
        jPanelColour095.setBackground(IOOperations.getColourFromHexString(colours[94]));
        jLayeredPane1.moveToBack(jPanelColour095);
        jPanelColour096.setBackground(IOOperations.getColourFromHexString(colours[95]));
        jLayeredPane1.moveToBack(jPanelColour096);
        jPanelColour097.setBackground(IOOperations.getColourFromHexString(colours[96]));
        jLayeredPane1.moveToBack(jPanelColour097);
        jPanelColour098.setBackground(IOOperations.getColourFromHexString(colours[97]));
        jLayeredPane1.moveToBack(jPanelColour098);
        jPanelColour099.setBackground(IOOperations.getColourFromHexString(colours[98]));
        jLayeredPane1.moveToBack(jPanelColour099);
        jPanelColour100.setBackground(IOOperations.getColourFromHexString(colours[99]));
        jLayeredPane1.moveToBack(jPanelColour100);
        jPanelColour101.setBackground(IOOperations.getColourFromHexString(colours[100]));
        jLayeredPane1.moveToBack(jPanelColour101);
        jPanelColour102.setBackground(IOOperations.getColourFromHexString(colours[101]));
        jLayeredPane1.moveToBack(jPanelColour102);
        jPanelColour103.setBackground(IOOperations.getColourFromHexString(colours[102]));
        jLayeredPane1.moveToBack(jPanelColour103);
        jPanelColour104.setBackground(IOOperations.getColourFromHexString(colours[103]));
        jLayeredPane1.moveToBack(jPanelColour104);
        jPanelColour105.setBackground(IOOperations.getColourFromHexString(colours[104]));
        jLayeredPane1.moveToBack(jPanelColour105);
        jPanelColour106.setBackground(IOOperations.getColourFromHexString(colours[105]));
        jLayeredPane1.moveToBack(jPanelColour106);
        jPanelColour107.setBackground(IOOperations.getColourFromHexString(colours[106]));
        jLayeredPane1.moveToBack(jPanelColour107);
        jPanelColour108.setBackground(IOOperations.getColourFromHexString(colours[107]));
        jLayeredPane1.moveToBack(jPanelColour108);
        jPanelColour109.setBackground(IOOperations.getColourFromHexString(colours[108]));
        jLayeredPane1.moveToBack(jPanelColour109);
        jPanelColour110.setBackground(IOOperations.getColourFromHexString(colours[109]));
        jLayeredPane1.moveToBack(jPanelColour110);
        jPanelColour111.setBackground(IOOperations.getColourFromHexString(colours[110]));
        jLayeredPane1.moveToBack(jPanelColour111);
        jPanelColour112.setBackground(IOOperations.getColourFromHexString(colours[111]));
        jLayeredPane1.moveToBack(jPanelColour112);
        jPanelColour113.setBackground(IOOperations.getColourFromHexString(colours[112]));
        jLayeredPane1.moveToBack(jPanelColour113);
        jPanelColour114.setBackground(IOOperations.getColourFromHexString(colours[113]));
        jLayeredPane1.moveToBack(jPanelColour114);
        jPanelColour115.setBackground(IOOperations.getColourFromHexString(colours[114]));
        jLayeredPane1.moveToBack(jPanelColour115);
        jPanelColour116.setBackground(IOOperations.getColourFromHexString(colours[115]));
        jLayeredPane1.moveToBack(jPanelColour116);
    }

    //load colours to physical keyboard
    private void loadColoursToPhysicalKeyboard(String[] colours) {
        gKeyboard.setProfile(convertG910ColourMapToStandard(colours));
    }
    ...
    private String[] getColoursFromVirtualKeyboard() {
        ...
        colours[37] = IOOperations.getHexStringFromColour(jPanelColour038.getBackground());
        colours[38] = IOOperations.getHexStringFromColour(jPanelColour039.getBackground());
        colours[39] = IOOperations.getHexStringFromColour(jPanelColour040.getBackground());
        colours[40] = IOOperations.getHexStringFromColour(jPanelColour041.getBackground());
        colours[41] = IOOperations.getHexStringFromColour(jPanelColour042.getBackground());
        colours[42] = IOOperations.getHexStringFromColour(jPanelColour043.getBackground());
        colours[43] = IOOperations.getHexStringFromColour(jPanelColour044.getBackground());
        colours[44] = IOOperations.getHexStringFromColour(jPanelColour045.getBackground());
        colours[45] = IOOperations.getHexStringFromColour(jPanelColour046.getBackground());
        colours[46] = IOOperations.getHexStringFromColour(jPanelColour047.getBackground());
        colours[47] = IOOperations.getHexStringFromColour(jPanelColour048.getBackground());
        colours[48] = IOOperations.getHexStringFromColour(jPanelColour049.getBackground());
        colours[49] = IOOperations.getHexStringFromColour(jPanelColour050.getBackground());
        colours[50] = IOOperations.getHexStringFromColour(jPanelColour051.getBackground());
        colours[51] = IOOperations.getHexStringFromColour(jPanelColour052.getBackground());
        colours[52] = IOOperations.getHexStringFromColour(jPanelColour053.getBackground());
        colours[53] = IOOperations.getHexStringFromColour(jPanelColour054.getBackground());
        ...
        colours[58] = IOOperations.getHexStringFromColour(jPanelColour059.getBackground());
        colours[59] = IOOperations.getHexStringFromColour(jPanelColour060.getBackground());
        colours[60] = IOOperations.getHexStringFromColour(jPanelColour061.getBackground());
        colours[61] = IOOperations.getHexStringFromColour(jPanelColour062.getBackground());
        colours[62] = IOOperations.getHexStringFromColour(jPanelColour063.getBackground());
        colours[63] = IOOperations.getHexStringFromColour(jPanelColour064.getBackground());
        colours[64] = IOOperations.getHexStringFromColour(jPanelColour065.getBackground());
        colours[65] = IOOperations.getHexStringFromColour(jPanelColour066.getBackground());
        colours[66] = IOOperations.getHexStringFromColour(jPanelColour067.getBackground());
        colours[67] = IOOperations.getHexStringFromColour(jPanelColour068.getBackground());
        colours[68] = IOOperations.getHexStringFromColour(jPanelColour069.getBackground());
        colours[69] = IOOperations.getHexStringFromColour(jPanelColour070.getBackground());
        colours[70] = IOOperations.getHexStringFromColour(jPanelColour071.getBackground());
        ...
        colours[74] = IOOperations.getHexStringFromColour(jPanelColour075.getBackground());
        colours[75] = IOOperations.getHexStringFromColour(jPanelColour076.getBackground());
        colours[76] = IOOperations.getHexStringFromColour(jPanelColour077.getBackground());
        colours[77] = IOOperations.getHexStringFromColour(jPanelColour078.getBackground());
        colours[78] = IOOperations.getHexStringFromColour(jPanelColour079.getBackground());
        colours[79] = IOOperations.getHexStringFromColour(jPanelColour080.getBackground());
        colours[80] = IOOperations.getHexStringFromColour(jPanelColour081.getBackground());
        colours[81] = IOOperations.getHexStringFromColour(jPanelColour082.getBackground());
        colours[82] = IOOperations.getHexStringFromColour(jPanelColour083.getBackground());
        colours[83] = IOOperations.getHexStringFromColour(jPanelColour084.getBackground());
        colours[84] = IOOperations.getHexStringFromColour(jPanelColour085.getBackground());
        colours[85] = IOOperations.getHexStringFromColour(jPanelColour086.getBackground());
        ...
        colours[89] = IOOperations.getHexStringFromColour(jPanelColour090.getBackground());
        colours[90] = IOOperations.getHexStringFromColour(jPanelColour091.getBackground());
        colours[91] = IOOperations.getHexStringFromColour(jPanelColour092.getBackground());
        colours[92] = IOOperations.getHexStringFromColour(jPanelColour093.getBackground());
        colours[93] = IOOperations.getHexStringFromColour(jPanelColour094.getBackground());
        colours[94] = IOOperations.getHexStringFromColour(jPanelColour095.getBackground());
        colours[95] = IOOperations.getHexStringFromColour(jPanelColour096.getBackground());
        colours[96] = IOOperations.getHexStringFromColour(jPanelColour097.getBackground());
        colours[97] = IOOperations.getHexStringFromColour(jPanelColour098.getBackground());
        colours[98] = IOOperations.getHexStringFromColour(jPanelColour099.getBackground());
        colours[99] = IOOperations.getHexStringFromColour(jPanelColour100.getBackground());
        colours[100] = IOOperations.getHexStringFromColour(jPanelColour101.getBackground());
        colours[101] = IOOperations.getHexStringFromColour(jPanelColour102.getBackground());
        colours[102] = IOOperations.getHexStringFromColour(jPanelColour103.getBackground());
        colours[103] = IOOperations.getHexStringFromColour(jPanelColour104.getBackground());
        colours[104] = IOOperations.getHexStringFromColour(jPanelColour105.getBackground());
        colours[105] = IOOperations.getHexStringFromColour(jPanelColour106.getBackground());
        colours[106] = IOOperations.getHexStringFromColour(jPanelColour107.getBackground());
        colours[107] = IOOperations.getHexStringFromColour(jPanelColour108.getBackground());
        colours[108] = IOOperations.getHexStringFromColour(jPanelColour109.getBackground());
        colours[109] = IOOperations.getHexStringFromColour(jPanelColour110.getBackground());
        colours[110] = IOOperations.getHexStringFromColour(jPanelColour111.getBackground());
        colours[111] = IOOperations.getHexStringFromColour(jPanelColour112.getBackground());
        colours[112] = IOOperations.getHexStringFromColour(jPanelColour113.getBackground());
        colours[113] = IOOperations.getHexStringFromColour(jPanelColour114.getBackground());
        colours[114] = IOOperations.getHexStringFromColour(jPanelColour115.getBackground());
        colours[115] = IOOperations.getHexStringFromColour(jPanelColour116.getBackground());
        return colours;
    }

    //convert colour array to match standard array
    private String[] convertG910ColourMapToStandard(String[] colours) {
        String[] convertedColours = new String[127];
        convertedColours[0] = colours[114];
        convertedColours[1] = colours[115];
        convertedColours[2] = colours[105];
        convertedColours[3] = colours[106];
        convertedColours[4] = colours[107];
        convertedColours[5] = colours[108];
        convertedColours[6] = colours[109];
        convertedColours[7] = colours[110];
        convertedColours[8] = colours[111];
        convertedColours[9] = colours[112];
        convertedColours[10] = colours[113];
        convertedColours[11] = colours[58];
        convertedColours[12] = colours[33];
        convertedColours[13] = colours[14];
        convertedColours[14] = "000000";
        convertedColours[15] = "000000";
        ...
        convertedColours[33] = colours[74];
        convertedColours[34] = colours[92];
        convertedColours[35] = colours[93];
        convertedColours[36] = colours[94];
        convertedColours[37] = colours[96];
        convertedColours[38] = colours[97];
        convertedColours[39] = colours[99];
        convertedColours[40] = colours[86];
        convertedColours[41] = colours[98];
        convertedColours[42] = colours[87];
        convertedColours[43] = colours[100];
        convertedColours[44] = colours[101];
        convertedColours[45] = colours[102];
        convertedColours[46] = colours[88];
        convertedColours[47] = colours[89];
        convertedColours[48] = colours[90];
        convertedColours[49] = colours[71];
        convertedColours[50] = colours[72];
        convertedColours[51] = colours[73];
        convertedColours[52] = colours[54];
        convertedColours[53] = colours[55];
        convertedColours[54] = colours[56];
        convertedColours[55] = colours[103];
        convertedColours[56] = colours[104];
        convertedColours[57] = colours[91];
        convertedColours[58] = colours[57];
        convertedColours[59] = colours[36];
        convertedColours[60] = colours[35];
        convertedColours[61] = colours[34];
        convertedColours[62] = colours[33];
        convertedColours[63] = colours[0];
        convertedColours[64] = colours[14];
        convertedColours[65] = colours[30];
        convertedColours[66] = colours[51];
        convertedColours[67] = colours[31];
        convertedColours[68] = colours[52];
        convertedColours[69] = colours[32];
        convertedColours[70] = colours[53];
        ...
        convertedColours[83] = colours[37];
        convertedColours[84] = colours[58];
        convertedColours[85] = colours[95];
        convertedColours[86] = colours[29];
        convertedColours[87] = colours[50];
        convertedColours[88] = colours[59];
        convertedColours[89] = colours[80];
        convertedColours[90] = colours[78];
        convertedColours[91] = colours[61];
        convertedColours[92] = colours[40];
        convertedColours[93] = colours[62];
        convertedColours[94] = colours[63];
        convertedColours[95] = colours[64];
        convertedColours[96] = colours[45];
        convertedColours[97] = colours[65];
        convertedColours[98] = colours[66];
        convertedColours[99] = colours[67];
        convertedColours[100] = colours[82];
        convertedColours[101] = colours[81];
        convertedColours[102] = colours[46];
        convertedColours[103] = colours[47];
        convertedColours[104] = colours[38];
        convertedColours[105] = colours[41];
        convertedColours[106] = colours[60];
        convertedColours[107] = colours[42];
        convertedColours[108] = colours[44];
        convertedColours[109] = colours[79];
        convertedColours[110] = colours[39];
        convertedColours[111] = colours[77];
        convertedColours[112] = colours[43];
        convertedColours[113] = colours[76];
    ...
    //convert G910 colour array into a standard array for both colours and their keys
    private String[][] convertG910ColourMapToStandardKeyColourMap(String[] colours) {
        String[][] keyColourMap = new String[2][127];
        String[] convertedColours = new String[127];
        convertedColours = convertG910ColourMapToStandard(colours);
        for (int i = 0; i < 127; i++) {
    ...
    //convert standard colour key array into a G910 colour array
    private String[] convertStandardKeyColourMapToG910ColourMap(String[][] keyColourMap) {
        String[] colourMap = new String[keyCount];
        String[] tempStandardColourMap = new String[127];
        for (int i = 0; i < 127; i++) {
            tempStandardColourMap[i] = keyColourMap[1][i];
        }
        colourMap = convertStandardColourMapToG910(tempStandardColourMap);
        return colourMap;
    }
